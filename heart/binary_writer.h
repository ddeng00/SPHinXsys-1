    ...
    for (SPHBody* body : bodies_) {
      if (body->checkNewlyUpdated()) {
        if (body->getBodyName() == "ExcitationHeart") {
          ...
          //     out_directory_ + "/SPHBody_" + body->getBodyName() + "_" + sequence + ".npz";
...
//class ReloadMaterialParameterIO_NPY : public ReloadMaterialParameterIO {
//  ReloadMaterialParameterIO_NPY(In_Output& in_output, BaseMaterial* material);
//  ReloadMaterialParameterIO_NPY(In_Output& in_output, BaseMaterial *material, std::string given_parameters_name);
//  ~ReloadMaterialParameterIO_NPY() override = default;
//
//  void writeToFile(size_t iteration_step = 0) override {
//
//  }
